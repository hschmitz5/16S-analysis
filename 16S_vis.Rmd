...
#setwd("C:/Users/schmi/OneDrive/Documents/GitHub/16S_analysis") # For Windows
...
#sam_dat <- sample_data(metadata)

#physeq_final <- merge_phyloseq(physeq_obj, sam_dat)


#metadata<-read_excel("./data/metadata.xlsx") # is data.frame
