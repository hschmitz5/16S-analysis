...
if (file.exists("aldex_clr_result.rds")) {
  x <- readRDS("aldex_clr_result.rds")
  kw.test <- readRDS("aldex_kw_result.rds")
} else {
  x <- aldex.clr(reads, conds, mc.samples=128, denom="all")
  kw.test <- aldex.kw(x)
   
  saveRDS(x, file = "aldex_clr_result.rds")
  saveRDS(kw.test, file = "aldex_kw_result.rds")
}
