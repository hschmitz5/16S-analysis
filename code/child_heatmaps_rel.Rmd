...
```{r all_high}
# DA_taxa <- get_common_taxa(ancom_fname, aldex_fname, high_ab_genera)
...
row_fontface <- ifelse(rownames(rel_wide) %in% DA_taxa, "bold", "plain")

```
# Plot all high abundance taxa
```{r heat_all}
